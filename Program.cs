    ...
    internal class Program
    {
        private static void Main()
        {
            ...
            foreach (var html in Directory.GetFiles("html\\", "*.html"))
            {
                ...
                data = data.Replace("<li class=\"footer\">Generated by <a href=\"https://www.doxygen.org/index.html\"><img class=\"footer\" src=\"doxygen.svg\" width=\"104\" height=\"31\" alt=\"doxygen\"/></a> 1.9.3 </li>", "<li class=\"footer\">Copyright ©2022 PsychoVertex</li>");
